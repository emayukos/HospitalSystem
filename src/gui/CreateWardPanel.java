...
public class CreateWardPanel extends JPanel {
    ...
    private class SubmitListener implements ActionListener {
        public void actionPerformed(ActionEvent event) {
            ...
            if (createWard.wasSuccessful()) { // open Main Menu window
                getTopLevelAncestor().setVisible(false); // closes start-up window
                MainMenuFrame frame = new MainMenuFrame(); // changed from PatientOpsFrame to MainMenuFrame */
                frame.setLocation(300, 300); // might need to change values
