    ...
    public DoctorOpsPanel() {
        ...
        addButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                DoctorAddFrame frame = new DoctorAddFrame(); // frame to enter data is created when button is pressed
        ...
        // add a button to display all doctors in the system
        ...
        exitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                exitButton.getTopLevelAncestor().setVisible(false); // window is no longer visible
            }
        });
        add(Box.createVerticalGlue());
    }
